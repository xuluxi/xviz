...
function testWriter(t, testCase, Writer, suffix) {
  ...
  testCase.preTest && testCase.preTest(t,testCase, writer, sink);
  ...
  testCase.postTest && testCase.postTest(t, testCase, writer, sink);
}
...
test('XVIZWriter#ThrowingTestCases', t => {
  for (let testCase of ThrowingTestCases) {
...
test('XVIZWriter#default-ctor frames writeFrameIndex', t => {
  ...
  for (let builder of [jsBuilder, binBuilder]) {
